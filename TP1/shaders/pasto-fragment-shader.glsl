      ...
      float cnoise(vec3 P){
        ...
        return 2.2 * n_xyz;
                ...
                void main(void) {
                   ...
                   vec3 pasto1=texture2D(uSampler2,vUv*11.0*scale1).xyz;
                   vec3 pasto2=texture2D(uSampler2,vUv*5.77*scale1).xyz;
                   vec3 pasto3=texture2D(uSampler2,vUv*1.11*scale1).xyz;
                   ...
                   mask1=smoothstep(-0.2,0.2,mask1);
                   
                   // combino tierra y roca usando la mascara 1
                   vec3 colorSuelo=mix(mix(tierra1,tierra2,0.5),roca,mask1);
                   ...
                   vec3 color=mix(colorPasto,colorSuelo,mask2);			   
                  
                  
                  //HASTA ACA LO QUE MOSTRO FEDERICO EN CLASE
                  //LUEGO PEGO LO MISMO QUE TENGO EN EL FRAGMENT SHADER
